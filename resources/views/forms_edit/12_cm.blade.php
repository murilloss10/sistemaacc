        ...
        <form action="{{url('editar/form12/salvar')}}" method="POST" class="col-md-12" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <select class="custom-select" id="inlineFormCustomSelect" name="tipo12">
                      <option value="Instrutor" {{($dados->tipo == "Instrutor") ? 'selected' : ''}}>Instrutor</option>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" id="namecourse" name="nome_curso12" value="{{$dados->nome_curso}}">
                    @error('nome_curso12')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input type="date" class="form-control" id="start" name="dt_inicio12" value="{{$dados->dt_inicio}}">
                    @error('dt_inicio12')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-4">
                    ...
                    <input type="date" class="form-control" id="finish" name="dt_fim12" value="{{$dados->dt_fim}}">
                    @error('dt_fim12')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <select class="custom-select" id="status" name="status12">
