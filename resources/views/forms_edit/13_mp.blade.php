        ...
        <form action="{{url('editar/form13/salvar')}}" method="POST" class="col-md-12" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" id="namemar" name="nome_maratona13" value="{{$dados->nome_maratona}}">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <input type="date" class="form-control" id="datte" name="dt_maratona13" value="{{$dados->dt_maratona}}">
                    @error('dt_maratona13')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <select class="custom-select" id="status" name="status13">
