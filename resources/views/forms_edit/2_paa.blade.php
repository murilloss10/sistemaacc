        ...
        <form action="{{url('editar/form2/salvar')}}" method="POST" class="col-md-12" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <select class="custom-select" id="inlineFormCustomSelect" name="tipo2">
                        ...
                        <option value="Artigo" {{($dados->tipo == "Artigo") ? 'selected' : ''}}>Artigo</option>
                        <option value="Resumo" {{($dados->tipo == "Resumo") ? 'selected' : ''}}>Resumo</option>
                    </select>
                    @error('tipo2')
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" placeholder="" id="titleAR" name="titulo2" value="{{$dados->titulo}}">
                    @error('titulo2')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <input type="text" class="form-control" placeholder="Nome da Revista ou Evento" id="whenPub" name="onde_pub2" value="{{$dados->onde_pub}}">
                    @error('onde_pub2')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-5">
                    ...
                    <input type="date" class="form-control" id="dateEvent" name="dt_pub2"  value="{{$dados->dt_pub}}">
                    @error('dt_pub2')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                <div class="col-md-4"><!-- div para status do arquivo -->
                    ...
                    <select class="custom-select" id="status" name="status2">
