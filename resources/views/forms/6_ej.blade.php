        ...
        <form action="{{url('submeter/form6/salvar')}}" method="POST" class="col-md-12" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" placeholder="" id="quant" name="quant_semestres6">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" placeholder="" id="start" name="dt_inicio6">
                    @error('dt_inicio6')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" placeholder="" id="finish" name="dt_fim6">
                    @error('dt_fim6')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
