...
<title>Cadastrar Usuário | SAACC</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{url('cadastar/usuario/salvar')}}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <input hidden id="type" type="text" class="form-control @error('type') is-invalid @enderror" name="type" value="normal" required autocomplete="name">
                            </div>
                        </div>
