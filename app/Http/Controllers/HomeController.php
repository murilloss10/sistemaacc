...
class HomeController extends Controller
{
    ...
    public function listActivities($id){
        if(Gate::authorize('administrador')){
            ...
            $dadosForm1 = Form1::where('usuario_id', $id)->get();
            $dadosForm2 = Form2::where('usuario_id', $id)->get();
            $dadosForm3 = Form3::where('usuario_id', $id)->get();
            $dadosForm4 = Form4::where('usuario_id', $id)->get();
            $dadosForm5 = Form5::where('usuario_id', $id)->get();
            $dadosForm6 = Form6::where('usuario_id', $id)->get();
            $dadosForm7 = Form7::where('usuario_id', $id)->get();
            $dadosForm8 = Form8::where('usuario_id', $id)->get();
            $dadosForm9 = Form9::where('usuario_id', $id)->get();
            $dadosForm10 = Form10::where('usuario_id', $id)->get();
            $dadosForm11 = Form11::where('usuario_id', $id)->get();
            $dadosForm12 = Form12::where('usuario_id', $id)->get();
            $dadosForm13 = Form13::where('usuario_id', $id)->get();
            $dadosForm14 = Form14::where('usuario_id', $id)->get();
            $dadosForm15 = Form15::where('usuario_id', $id)->get();
            $dadosForm16 = Form16::where('usuario_id', $id)->get();
            $dadosForm17 = Form17::where('usuario_id', $id)->get();
            $dadosForm18 = Form18::where('usuario_id', $id)->get();
            $dadosForm19 = Form19::where('usuario_id', $id)->get();
            $dadosForm20 = Form20::where('usuario_id', $id)->get();
            $dadosForm21 = Form21::where('usuario_id', $id)->get();
            $dadosForm22 = Form22::where('usuario_id', $id)->get();
            $dadosForm23 = Form23::where('usuario_id', $id)->get();
            $dadosForm24 = Form24::where('usuario_id', $id)->get();
            $dadosForm25 = Form25::where('usuario_id', $id)->get();
            $authorized = $id;
